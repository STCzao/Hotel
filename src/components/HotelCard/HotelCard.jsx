...
const HotelCard = ({ room, index }) => {
  return (
    <Link to={"/rooms/" + room._id} onClick={() => (0, 0)} key={room._id}>
      <img
        src={room.images[0]}
        alt=""
      ...
      <div className="p-4 pt-5">
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <button className="px-4 py-2 text-sm font-medium border border-gray-300 rouded hover:bg-gray-50 transition-all cursor-pointer">
            Book Now
          </button>
        </div>
      </div>
